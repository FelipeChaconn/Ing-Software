                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('detail') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('detail') ? ' is-invalid' : '' }}" name="detail" id="input-detail" type="text" placeholder="{{ __('Description') }}" value="{{ old('detail', $category->detail) }}" required />
