 ...
 * @author Luis Felipe
 */
public class Date_iniMov extends javax.swing.JDialog {

    /**
     * Creates new form Date_iniMov
     */
    public Date_iniMov(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    @SuppressWarnings("unchecked")
       public static String nowMov = null;
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(calendariopeli, javax.swing.GroupLayout.DEFAULT_SIZE, 446, Short.MAX_VALUE)
                    .addContainerGap()))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Date_iniMov.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Date_iniMov dialog = new Date_iniMov(new javax.swing.JFrame(), true);
